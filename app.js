...
edad < 18 ? alert("Usted no podra realizar pagos dentro de esta pagina") : alert("Usted podra realizar pagos dentro de la pagina");

// ||
let ingreso = prompt("ingrese su nombre y sera registrado");
localStorage.setItem("nombre", ingreso || "usuario no existe");
alert("Hola " + `${ingreso} ` + "estas en SneakersShop");
